...
export default function Pricing() {
  return (
    <div className="my-37.5 flex flex-col items-center gap-14 ">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-content-body text-xl text-center">
          ...
          <strong className="text-accent-pink">{TRIAL_DAYS} dias</strong>, sem compromisso!
        </p>
      </div>
      <div className="flex items-end gap-9">
        <div className="w-76 p-8 flex flex-col gap-7 rounded-2xl border border-[#1E1E1E] ">
        ...
        <div className="flex flex-col">
          <div className="flex justify-center items-center rounded-t-2xl p-2 w-76 bg-[linear-gradient(90deg,#4B2DBB_0%,#B5446B_100%)]">
